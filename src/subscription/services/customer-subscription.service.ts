...
export class CustomerSubscriptionService {
   ...
   */
   async createSubscription(user: User, dto: CreateSubscriptionDto) {
    ...
    this.deliveryFrequencyService.validateFrequency(dto.frequency, dto.custom_days);

    const customDays = dto.frequency === SubscriptionFrequency.CUSTOM_DAYS ? dto.custom_days : [];
